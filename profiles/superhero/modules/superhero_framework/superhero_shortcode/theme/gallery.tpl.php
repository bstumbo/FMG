...
<div class="gallery-filters btn-group">
	<a href="#" class="btn active" data-filter="*"><?php print t('Show All');?></a><?php foreach($categories as $category):?><a href="#" class="btn" data-filter=".<?php print drupal_html_class($category);?>"><?php print $category;?></a><?php endforeach;?>
</div>
<?php endif;?>
