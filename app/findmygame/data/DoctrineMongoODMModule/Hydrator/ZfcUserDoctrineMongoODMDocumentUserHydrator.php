...
class ZfcUserDoctrineMongoODMDocumentUserHydrator implements HydratorInterface
{
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        /** @Field(type="string") */
        if (isset($data['displayName']) || (! empty($this->class->fieldMappings['displayName']['nullable']) && array_key_exists('displayName', $data))) {
            ...
            $this->class->reflFields['displayName']->setValue($document, $return);
            $hydratedData['displayName'] = $return;
        }
